...
import de.envite.greenbpm.carbonreductor.api.carbon.aware.auth.ApiKeyAuth;
import de.envite.greenbpm.carbonreductor.api.carbon.aware.auth.Authentication;
import de.envite.greenbpm.carbonreductor.api.carbon.aware.auth.HttpBasicAuth;
import de.envite.greenbpm.carbonreductor.api.carbon.aware.auth.OAuth;
...
public class ApiClient {
  ...
  public String parameterToString(Object param) {
    if (param == null) {
      ...
      String formattedString = ((OffsetDateTime) param).format(dateTimeFormatter);
      String jsonStr = json.serialize(formattedString);
      return jsonStr.substring(1, jsonStr.length() - 1);
