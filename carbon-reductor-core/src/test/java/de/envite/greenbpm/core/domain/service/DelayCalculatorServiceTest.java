package de.envite.greenbpm.core.domain.service;

import de.envite.greenbpm.core.TestDataGenerator;
...
import de.envite.greenbpm.core.domain.model.emissionframe.ForecastedValue;
import de.envite.greenbpm.core.domain.model.emissionframe.OptimalTime;
import de.envite.greenbpm.core.domain.model.emissionframe.Rating;
...
import de.envite.greenbpm.core.domain.model.input.location.Locations;
import de.envite.greenbpm.core.usecase.out.CarbonEmissionQuery;
...
import static de.envite.greenbpm.core.TestDataGenerator.createTimeshiftWindowCarbonReductorInput;
...
class DelayCalculatorServiceTest {
    ...
    void init() {
        ...
        delayedWorkerExecutionTimeshiftInput = createTimeshiftWindowCarbonReductorInput(
        ...
        immediateWorkerExecutionTimeshiftInput = createTimeshiftWindowCarbonReductorInput(
